...
var NextPageButton = function NextPageButton(_ref) {
    ...
    var nextClass = '\n    ' + (css ? css : 'btn btn-link text-white pl-2') + '\n    ' + (page === pages ? ' disabled' : '') + '\n  ';
...
var PreviousPageButton = function PreviousPageButton(_ref) {
    ...
    var prevClass = '\n    ' + (css ? css : 'btn btn-link text-white pr-2') + '\n    ' + (page === 1 ? ' disabled' : '') + '\n  ';
...
var ZoomIn = function ZoomIn(_ref) {
    ...
    var zoomInClass = '' + (css ? css : 'btn btn-link text-white pl-2') + (scale === maxScale ? ' disabled' : '');
...
var ZoomOut = function ZoomOut(_ref) {
    ...
    var zoomOutClass = '' + (css ? css : 'btn btn-link text-white pr-2') + (scale === minScale ? ' disabled' : '');
...
var ResetZoom = function ResetZoom(_ref) {
    ...
    var resetZoomClass = (css ? css : 'btn btn-link text-white px-2') + '\n    ' + (scale === defaultScale ? ' disabled' : '');
...
var Navigation = function Navigation(_ref) {
    ...
    return React.createElement(
        'div',
        {
            className: css.navbarWrapper ? css.navbarWrapper : 'rounded bg-dark text-white' },
        React.createElement(
            'div',
            { className: 'row' },
            React.createElement(
                'div',
                { className: 'col-sm-4 scale_width_set' },
            ...
            React.createElement(
                'div',
                { className: 'col-sm-4 previous_next_btn' },
                React.createElement(
                    'div',
                    { className: 'btn-group', role: 'group' },
            ...
            React.createElement(
                'div',
                { className: 'col-sm-4 rotate_left' },
