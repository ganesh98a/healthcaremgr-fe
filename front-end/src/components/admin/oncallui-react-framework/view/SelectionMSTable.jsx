...
import { checkItsNotLoggedIn, toastMessageShow, postData } from 'service/common.js';
import 'react-block-ui/style.css';
import 'service/jquery.validate.js';
import "service/custom_script.js";
import CustomMSModal from './CustomMSModal';
 ...
 */
class SelectionMSTable extends Component {
    ...
    render() {
        return (
            <CustomMSModal 
                showModal={true}
                heading={this.props.heading || "Add Applicants to The Group Booking"}
                size="large"
...
export default SelectionMSTable;