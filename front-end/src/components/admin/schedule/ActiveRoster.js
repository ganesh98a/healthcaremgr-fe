        ...
        const columns = [
...

            {
                Cell: (props) => <span className="d-flex w-100 justify-content-center align-item-center">
                    <span title={ParticiapntPageIconTitle.par_history_icon} onClick={() => this.setState({ historyId: props.original.id, open_history: true })} className="short_buttons_01 mr-1">View History</span>
                    <Link title={ParticiapntPageIconTitle.par_view_icon} to={{ pathname: '/admin/schedule/roster_details/' + props.original.id }} className="short_buttons_01 ml-1">View Roster</Link>
            ...
            <React.Fragment>
                ...
                <div className="tab-content">
                    <div role="tabpanel" className="tab-pane active" id={this.state.active_panel}>
                        ...
                        <div className="row">
                            <div className="col-md-12 schedule_active_roster_Table">
