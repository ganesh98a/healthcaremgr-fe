...
class CreateLocationModel extends Component {
    ...
    submit = (e) => {
        ...
        var url = 'item/ParticipantLocation/create_participant_location';
        var validator = jQuery("#create_location").validate({ ignore: [] });

        // Allow only validation is passed
        if (!this.state.loading && jQuery("#create_location").valid()) {
                    ...
                    >
                        <section className="manage_top" >
                            <div className="container-fluid">
                                <form id="create_location" autoComplete="off" className="slds_form">
                                                ...
                                                <div className="slds-form-element__control">
                                                    ...
                                                    <div className="slds-form-element__control">
                                                        <input type="text"
                                                            ...
                                                            onChange={(value) => this.setState({ unit_number: value.target.value })}
