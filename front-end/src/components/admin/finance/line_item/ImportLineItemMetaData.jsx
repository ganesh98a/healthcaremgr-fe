...
class ImportLineItemMetaData extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeCol: '',
  ...
  uploadHandler = e => {
    ...
    if (jQuery("#import_line_item_from").valid()) {
      ...
      postImageData("finance/FinanceImportExportLineItem/meta_data_from_data_sheet", formData, this).then(responseData => {
        var x = responseData;
...
export default connect(mapStateToProps, mapDispatchtoProps)(ImportLineItemMetaData);