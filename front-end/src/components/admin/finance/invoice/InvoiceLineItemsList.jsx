...
/**
 * RequestData get the list of invoice line_items
 */
 ...
 */
class ListInvoiceLineItems extends Component {
    ...
    showArchiveModal(line_item_id) {
        showArchiveInvoiceLineItemModal(line_item_id, this.props.invoice_id, this.setTableParams, this.get_invoice_details);
    }
    ...
    handleOnRenderActions = () => {
        return (
            <React.Fragment>
                <PageHeaderControl>
                    <Button label="Edit" onClick={e => this.showModal()} disabled={this.state.status >= 1 ? true : false} />
                </PageHeaderControl>
            </React.Fragment> 
        )
    }
...
export default connect(mapStateToProps, mapDispatchtoProps)(ListInvoiceLineItems);