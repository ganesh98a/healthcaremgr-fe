...
/**
 * Class: ImportPayRateModel
 */
class ImportPayRateModel extends Component {
    constructor(props) {
        super(props);
    ...
    submit = (e) => {
        e.preventDefault();
        jQuery("#import_payrate").validate({ /* */ });
        var url = 'finance/FinanceDashboard/import_payrates';
        var validator = jQuery("#import_payrate").validate({ ignore: [] });
                ...
                >
                    <section className="manage_top" >
                        <div className="container-fluid">
                            <form id="import_payrate" autoComplete="off" className="slds_form">
                                ...
                                <div className="row pt-2 pb-5">
                                    ...
                                    <div className="col-sm-12 text-center">
                                        <div className="slds-form-element" >
                                            <label className="slds-form-element__label" htmlFor="text-input-id-1">
                                            CSV columns allowed: <abbr className="slds-required" title="required">* </abbr>category, <abbr className="slds-required" title="required">* </abbr>award, <abbr className="slds-required" title="required">* </abbr>role, <abbr className="slds-required" title="required">* </abbr>pay_level, <abbr className="slds-required" title="required">* </abbr>skill, <abbr className="slds-required" title="required">* </abbr>employment_type, <abbr className="slds-required" title="required">* </abbr>start_date, <abbr className="slds-required" title="required">* </abbr>end_date, <abbr className="slds-required" title="required">* </abbr>amount, external_reference, description</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
export default (ImportPayRateModel)  