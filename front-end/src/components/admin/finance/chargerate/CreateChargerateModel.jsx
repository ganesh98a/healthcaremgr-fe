...
/**
 * Class: CreateChargerateModel
 */
class CreateChargerateModel extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            loading: false,
            charge_rate_id: this.props.id ? this.props.id : '',
            role_details: '',
            charge_rate_category_id: '',
            pay_level_id: '',
            skill_level_id: '',
            cost_book_id: '',
            start_date: '',
            ...
            description: '',
            status: '0',
            chargerates_category_options: [],
            chargerates_award_options: [],
            cost_book_options: [],
            skill_level_options: [],
            pay_level_options: []
        }
    ...
    /**
     * fetching the charge rate details if the modal is opened in the edit mode
     */
    get_charge_rate_details = (id) => {
        postData('finance/FinanceDashboard/get_charge_rate_details', { id }).then((result) => {
            if (result.status) {
    ...
    componentDidMount() {
        ...
        this.get_charge_rate_ref_data();

        if(this.props.id) {
            this.setState({ charge_rate_id: this.props.id });
            this.get_charge_rate_details(this.props.id);
        }
    ...
    /**
     * Calling the API to create/update the chargerate
     */
    submit = (e) => {
        e.preventDefault();
        jQuery("#create_chargerate").validate({ /* */ });        
        var url = 'finance/FinanceDashboard/create_update_charge_rate';
        var validator = jQuery("#create_chargerate").validate({ ignore: [] });
        
        // Allow only if validation is passed
        if (!this.state.loading && jQuery("#create_chargerate").valid()) {
            this.setState({ loading: true });
            var req = {
                id: this.state.charge_rate_id,
                charge_rate_category_id: this.state.charge_rate_category_id,
                ...
                cost_book_id: this.state.cost_book_id,
    ...
    RenderAddEditForm() {
        return (
            <form id="create_chargerate" autoComplete="off" className="slds_form">
                <div className="container-fluid">
                                ...
                                <div className="slds-form-element__control">
                                    <div className="SLDS_date_picker_width">
                                        <SLDSReactSelect
                                            ...
                                            options={this.state.chargerates_category_options}
                                            onChange={(value) => this.handleChange(value, 'charge_rate_category_id')}
                                            value={this.state.charge_rate_category_id || ''}
                                            clearable={true}
                                            searchable={true}
                                            placeholder="Please Select"
                                            required={true}
                                            name="Chargerates Category"
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row py-2">
                        <div className="col-sm-6">
                            <div className="slds-form-element">
                                <label className="slds-form-element__label"><abbr className="slds-required" title="required">* </abbr>Role</label>
                                <div className="slds-form-element__control">
                                    <div className="SLDS_date_picker_width">
                    ...
                    <div className="row py-2">
                        ...
                        <div className="col-sm-6">
                            <div className="slds-form-element">
                                <label className="slds-form-element__label"><abbr className="slds-required" title="required">* </abbr>Cost Book</label>
                                <div className="slds-form-element__control">
                                    <div className="SLDS_date_picker_width">
                                        <SLDSReactSelect
                                            simpleValue={true}
                                            ...
                                            onChange={(value) => this.handleChange(value, 'cost_book_id')}
            ...
            <React.Fragment>
                <IconSettings iconPath={"/assets/salesforce-lightning-design-system/assets/icons"}>
                    <Modal
                        ...
                        heading={this.props.id ? "Update Charge Rate" : "New Charge Rate"}
                        size="small"
...
export default CreateChargerateModel;
