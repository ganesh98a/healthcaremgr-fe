...
import { SelectList } from '../../../oncallui-react-framework';
...
import form from '../../../oncallui-react-framework/services/form';
...
const getDocumentName = (e, data) => {
    return queryOptionData(e, "recruitment/RecruitmentApplicant/get_attachment_category_details_search", { query: e }, 2, 1);
}
...
class CreateDocumentModel extends Component {
    ...
    submit = (e) => {
        e.preventDefault();
        jQuery("#create_applicant_document").validate({ /* */ });
        //let errors = new form(this.formRef).validateForm();
        var url = 'recruitment/RecruitmentApplicant/save_applicant_document';
        var validator = jQuery("#create_applicant_document").validate({ ignore: [] });
        var validCheck = this.validCheck();
        // Allow only validation is passed
        if (validCheck && !this.state.loading && jQuery("#create_applicant_document").valid()) {
                        ...
                        <section className="manage_top" >
                            <form ref={this.formRef}>
                                <div className="container-fluid">
                                    <form id="create_applicant_document" autoComplete="off" className="slds_form">
                                        <div className="row py-2">
                                            ...
                                            {this.props.user_page!='application_details' &&<div className="col-sm-6">
                                                <div className="slds-form-element">
                                        ...
                                        <div className="col-sm-6">
                                            <div className="slds-form-element">
                                                ...
                                                <div className="slds-form-element__control wordWrap" >
                                                <SLDSReactSelect
                                                        required={true}
                                                        simpleValue={true}
                                        ...
                                        {license && <Row>
                                            <Col50>
                                                <SelectList
                                                    ...
                                                    required={this.state.license_type == "3"}
                                                    clearable
                                                ...
                                                <div className="slds-form-element" >
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-sm-8">
                                                            {
                                                                this.state.files.map((val, index) => (
                                                                    <div key={index + 1} className="attach_txt pt-1"><span>{((val.name).length > 30) ? (((val.name).substring(0, 30 - 3)) + '...' + '  (.' + val.ext + ')') : (val.name)}</span></div>
                                                                ))}
                                                        </div>
                                                    </div>
                                                </div>
