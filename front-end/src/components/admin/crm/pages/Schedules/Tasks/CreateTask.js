...
class CreateTask extends Component {
    ...
    custom_validation = () => {
        var return_var = true;
        var state = {};
        var List = [{ key: 'due_date' }, { key: 'crm_participant_id' }, { key: 'priority' }];
                        ...
                        <form id="create_task">
                            ...
                            <div className="custom-modal-footer bt-1 mt-5 px-0 pb-4">
                                <div className="row d-flex justify-content-end">
                                    <div className="col-md-2"> <a className="btn-1" disabled={this.state.disabled} onClick={this.submit}>Create Task</a></div>
                                </div>
                            </div>
