...
class ImportCsvContact extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activeCol: '',
  ...
  uploadHandler = e => {
    ...
    //   formData.append("end_date", this.state.end_date);
      ...
      postImageData("sales/ContactImport/read_csv_contacts", formData, this).then(responseData => {
        var x = responseData;
          ...
          <div className="col-lg-12">
            <div className=" py-4">
              <span className="back_arrow">
                <Link to={"/admin/crm/contact/listing"}><span className="icon icon-back1-ie"></span></Link>
              </span>
            </div>
            ...
            <div className="by-1">
              <div className="row d-flex  py-4">
                <div className="col-lg-8">
                  <div className="h-h1 color">Import CSV Contacts</div>
                </div>
