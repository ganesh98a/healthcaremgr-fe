...
import EditBehvSupport from './EditBehvSupport';
 ...
 */
class EditBehvSuppModal extends React.Component {
    ...
    handleSubmit = e => {
        ...
        postData('sales/RiskAssessment/save_all_behavsupport_matrices', { risk_assessment_id, rows: rowsWithRisk }).then(res => {
            if (res.status) {
                toastMessageShow(res.msg, 's')
                this.props.onSuccess()
            } else {
                toastMessageShow("Please enter details to save!", 'e')
            }
        ...
        return (
            <IconSettings iconPath={"/assets/salesforce-lightning-design-system/assets/icons"}>
                <Modal
                    ...
                    heading={'Edit Behaviour Support Matrix'}
                    size="small"
...
export default EditBehvSuppModal